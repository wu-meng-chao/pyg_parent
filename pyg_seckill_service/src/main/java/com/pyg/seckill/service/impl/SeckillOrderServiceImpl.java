...
public class SeckillOrderServiceImpl implements SeckillOrderService {
    ...
    public void submitOrder(Long seckillId, String userId) {
        ...
        if(seckillGoods.getStockCount()==0){//如果库存为0
        ...
        seckillOrder.setStatus("0");//状态,0:未付款，1：已付款
     ...
     */
    @Override
    public void updateOrderStatus(String userId, Long orderId, String transactionId) {
        ...
        seckillOrder.setStatus("1");//状态,0:未付款，1：已付款
